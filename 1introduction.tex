\chapter{Überblick} \label{ch:introduction}
 ...
 \section{Einleitung} \label{sec:einl}
	...
	Im Rahmen der Konzeption des \ac{cdw} für ein  \ac{diz} des Konsortiums \href{https://www.miracum.org/}{\ac{miracum}} der \href{https://www.medizininformatik-initiative.de/de}{\ac{mii}} muss diese Situation abgebildet werden.% \cite{willidea}. 
