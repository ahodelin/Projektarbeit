	\ProvideAcroEnding{genitivsingularmaskulin}{s}{s}
	\ProvideAcroEnding{dativplural}{n}{n}
	
	\ExplSyntaxOn
	\NewAcroCommand \acg
	{
		\acro_genitivsingularmaskulin:
		\acro_use:n {#1}
	}
	%\ExplSyntaxOff
	...
	\DeclareAcronym{alphaid}{
		...
		long-genitivsingularmaskulin-form = {Alpha-Identifikatoren}
	}
	...
	\DeclareAcronym{bfarm}
	{
		...
		long-genitivsingularmaskulin-form = {Bundesinstituts für Arzneimittel und Medizinprodukte}
	}
	...
	\DeclareAcronym{bmg}
	{
		...
		long-genitivsingularmaskulin-form = {Bundesministeriums für Gesundheit}
	}
	\DeclareAcronym{cdw}
	{	short = CDW,
