...
Die \ac{icd10gm} ist die amtliche Klassifikation zur Verschlüsselung von Diagnosen in der ambulanten (\S 295 \acsu{sgb} V) und stationären (\S 301 \ac{sgb} V) Versorgung in Deutschland, deren Versionen und Formaten gelten vom Anfang bis zum Ende eines Jahres und werden im Auftrag des Bundesministeriums für Gesundheit (\acs{bmg}) von dem \ac{bfarm} jährlich aktualisiert und herausgegeben \cite{icd10}. 
