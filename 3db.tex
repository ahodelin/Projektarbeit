...
Die Tabelle \glqq\textsf{kodes}\grqq{} vom \ac{bfarm}-Schema beinhalten die semantische Information der \ac{csv}-Dateien von nur einer Fassung und enthält damit die Anfangsdaten für die Tabellen \glqq\textsf{icd10gm}\grqq{} und \glqq\textsf{icd10gm\_history}\grqq{}.
