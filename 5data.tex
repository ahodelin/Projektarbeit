...
\begin{table}[ht]
	...
	\label{tab:icdeuropa}
	\begin{tabular}{|l|l|p{8.5cm}|l|l|}
		\hline
		\rowcolor{lightgray} Änderung & Code & Titel & Alt & Neue \\ \hline
